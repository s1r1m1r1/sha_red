...
Unauthenticated_WsFromServer _$Unauthenticated_WsFromServerFromJson(
  Map<String, dynamic> json,
) => Unauthenticated_WsFromServer(
  WsErrorPayload.fromJson(json['dto'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$Unauthenticated_WsFromServerToJson(
  Unauthenticated_WsFromServer instance,
) => <String, dynamic>{'dto': instance.dto, 'runtimeType': instance.$type};
