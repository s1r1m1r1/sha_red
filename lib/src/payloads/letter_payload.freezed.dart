...
mixin _$LetterDto {
 ...
 int get id; String get chatRoomId; int get senderId; String get content; DateTime get createdAt;
...
@useResult
$Res call({
 int id, String chatRoomId, int senderId, String content, DateTime createdAt
});
