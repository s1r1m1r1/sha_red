...
/// Adds pattern-matching-related methods to [OnlineMemberPayload].
extension OnlineMemberPayloadPatterns on OnlineMemberPayload {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OnlineMemberPayload value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _OnlineMemberPayload() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OnlineMemberPayload value)  $default,){
final _that = this;
switch (_that) {
case _OnlineMemberPayload():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OnlineMemberPayload value)?  $default,){
final _that = this;
switch (_that) {
case _OnlineMemberPayload() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<OnlineMemberDto> members)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnlineMemberPayload() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<OnlineMemberDto> members)  $default,) {final _that = this;
switch (_that) {
case _OnlineMemberPayload():
return $default(_that.members);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<OnlineMemberDto> members)?  $default,) {final _that = this;
switch (_that) {
case _OnlineMemberPayload() when $default != null:
return $default(_that.members);case _:
  return null;
...
/// Adds pattern-matching-related methods to [OnlineMemberDto].
extension OnlineMemberDtoPatterns on OnlineMemberDto {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OnlineMemberDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _OnlineMemberDto() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OnlineMemberDto value)  $default,){
final _that = this;
switch (_that) {
case _OnlineMemberDto():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OnlineMemberDto value)?  $default,){
final _that = this;
switch (_that) {
case _OnlineMemberDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int unitId,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnlineMemberDto() when $default != null:
return $default(_that.unitId,_that.name);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int unitId,  String name)  $default,) {final _that = this;
switch (_that) {
case _OnlineMemberDto():
return $default(_that.unitId,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int unitId,  String name)?  $default,) {final _that = this;
switch (_that) {
case _OnlineMemberDto() when $default != null:
return $default(_that.unitId,_that.name);case _:
  return null;
